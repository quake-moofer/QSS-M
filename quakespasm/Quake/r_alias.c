...
void GL_DrawAliasShadow(entity_t* e)
{
	...
	shade = (((lightcolor[1] + lightcolor[2] + lightcolor[3]) / 3) / 128);//R00k   rook / woods
	...
	glDisable(GL_TEXTURE_2D);
	shading = false;
	//	glColor4f(0,0,0,entalpha * 0.5); rook / woods OLD
	glColor4f(0, 0, 0, entalpha * shade);//R00k : fade light based on ambientlight   rook / woods
